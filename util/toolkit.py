...
def uappend(lststr):
    return configindb.Application_Config['app_param_prefix']+'{}'.format(lststr)

def uappendlist(slist):
    return list(map(uappend, slist))

def gen_dburi():
    db = {'drivername': configindb.Database_Config['db_drivername'],
          'username': configindb.Database_Config['db_username'],
          'password': parse.unquote_plus(configindb.Database_Config['db_password']),
          'host': configindb.Database_Config['db_host'],
          'port': configindb.Database_Config['db_port'],
          'database': configindb.Database_Config['db_name']
          }
