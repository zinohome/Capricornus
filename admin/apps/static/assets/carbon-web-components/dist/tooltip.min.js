 ...
 * LICENSE file in the root directory of this source tree.
 */
let B,A;i([f(`${T}-tooltip-body`)],(function(t,o){class i extends o{constructor(...o){super(...o),t(this)}}return{F:i,d:[{kind:"field",decorators:[_()],key:"alignment",value:()=>c.CENTER},{kind:"field",decorators:[_()],key:"direction",value:()=>m.BOTTOM},{kind:"field",decorators:[_({type:Boolean,reflect:!0})],key:"open",value:()=>!1},{kind:"field",decorators:[n("keydown")],key:"_handleKeydown",value(){return async t=>{"Escape"===t.key&&(this.open=!1)}}},{kind:"get",key:"position",value:function(){const{direction:t}=this,o=r(x(i.prototype),"position",this),{direction:e,start:b,top:l}=o;if(t===m.LEFT){const t=this.ownerDocument.defaultView.getComputedStyle(this),i=Number((/^([\d-.]+)px$/.exec(t.getPropertyValue(e!==v.RTL?"margin-right":"margin-left"))||[])[1]);if(!isNaN(i))return d(d({},o),{},{start:b-i})}if(t===m.TOP){const t=this.ownerDocument.defaultView.getComputedStyle(this),i=Number((/^([\d-.]+)px$/.exec(t.getPropertyValue("margin-bottom"))||[])[1]);if(!isNaN(i))return d(d({},o),{},{top:l-i})}return o}},{kind:"method",key:"connectedCallback",value:function(){this.hasAttribute("role")||this.setAttribute("role","menu"),this.hasAttribute("tabindex")||this.setAttribute("tabindex","-1"),r(x(i.prototype),"connectedCallback",this).call(this)}},{kind:"method",key:"render",value:function(){return e(Y||(Y=X` <span class="${0}--tooltip__caret"></span> <div class="${0}--tooltip__content"><slot></slot></div> `),T,T)}},{kind:"field",static:!0,key:"styles",value:()=>w}]}}),h),function(t){t.START="start",t.CENTER="center",t.END="end"}(B||(B={})),function(t){t.LEFT="left",t.TOP="top",t.RIGHT="right",t.BOTTOM="bottom"}(A||(A={}));let j,C=t=>t;const{prefix:N}=l;let M,S=i([f(`${N}-tooltip-definition`)],(function(t,o){return{F:class extends o{constructor(...o){super(...o),t(this)}},d:[{kind:"field",decorators:[_()],key:"alignment",value:()=>B.CENTER},{kind:"field",decorators:[_({attribute:"body-text"})],key:"bodyText",value:()=>""},{kind:"field",decorators:[_()],key:"direction",value:()=>A.BOTTOM},{kind:"method",key:"createRenderRoot",value:function(){var t;return this.attachShadow({mode:"open",delegatesFocus:Number((null!==(t=/Safari\/(\d+)/.exec(navigator.userAgent))&&void 0!==t?t:["",0])[1])<=537})}},{kind:"method",key:"render",value:function(){const{alignment:t,bodyText:o,direction:i}=this,b=u({[`${N}--tooltip__trigger`]:!0,[`${N}--tooltip--a11y`]:!0,[`${N}--tooltip__trigger--definition`]:!0,[`${N}--tooltip--${i}`]:i,[`${N}--tooltip--align-${t}`]:t});return e(j||(j=C` <button class="${0}" aria-describedby="tooltip-body"> <slot></slot> </button> <div class="${0}--assistive-text" id="tooltip-body" role="tooltip"> <slot name="body">${0}</slot> </div> `),b,N,o)}},{kind:"field",static:!0,key:"styles",value:()=>w}]}}),y(b)),E=t=>t;const{prefix:F}=l;i([f(`${F}-tooltip-footer`)],(function(t,o){return{F:class extends o{constructor(...o){super(...o),t(this)}},d:[{kind:"method",key:"render",value:function(){return e(M||(M=E`<slot></slot>`))}},{kind:"field",static:!0,key:"styles",value:()=>w}]}}),b);let R,q=t=>t;const{prefix:O}=l;i([f(`${O}-tooltip-icon`)],(function(t,o){return{F:class extends o{constructor(...o){super(...o),t(this)}},d:[{kind:"method",key:"render",value:function(){const{alignment:t,bodyText:o,direction:i}=this,b=u({[`${O}--tooltip__trigger`]:!0,[`${O}--tooltip--a11y`]:!0,[`${O}--tooltip--${i}`]:i,[`${O}--tooltip--align-${t}`]:t});return e(R||(R=q` <button class="${0}" aria-describedby="tooltip-body"> <span class="${0}--assistive-text" id="tooltip-body" role="tooltip"> <slot name="body">${0}</slot> </span> <slot></slot> </button> `),b,O,o)}}]}}),S);
