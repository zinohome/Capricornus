...
export { default as CustomElement } from '../../components/data-table/table-header-cell-skeleton.js';
...
const Component = createReactCustomElementType(''.concat(prefix, '-table-header-cell-skeleton'), descriptor);
