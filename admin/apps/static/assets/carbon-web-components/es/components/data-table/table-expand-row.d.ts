...
declare const BXTableExpandRow_base: {
    new (...args: any[]): {
 ...
 */
declare class BXTableExpandRow extends BXTableExpandRow_base {
    /**
     ...
     */
    private _handleUserInitiatedToggleExpando;
    protected _renderFirstCells(): import("lit-element").TemplateResult;
    /**
...
//# sourceMappingURL=table-expand-row.d.ts.map
