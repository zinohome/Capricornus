 ...
 * @private
 */
export declare const _createHandleFeedbackTooltip: (update: (properties: {
 ...
 * @private
 */
export declare const _renderButton: ({ assistiveText, feedbackText, showFeedback, className, children, handleClickButton, }: {
...
declare const BXCopyButton_base: {
    new (...args: any[]): {
        focus(): void;
        accessKey: string;
 ...
 */
declare class BXCopyButton extends BXCopyButton_base {
    /**
