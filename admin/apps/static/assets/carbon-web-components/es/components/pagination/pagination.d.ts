...
declare const BXPagination_base: {
    new (...args: any[]): {
        focus(): void;
        accessKey: string;
 ...
 */
declare class BXPagination extends BXPagination_base {
    /**
