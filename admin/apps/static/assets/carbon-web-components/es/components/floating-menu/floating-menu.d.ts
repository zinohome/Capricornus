...
declare const BXFloatingMenu_base: {
    new (...args: any[]): {
        _handles: Set<Handle>;
 ...
 * Floating menu.
 */
declare abstract class BXFloatingMenu extends BXFloatingMenu_base {
    /**
     ...
     */
    protected parent: BXFloatingMenuTrigger | null;
    /**
     ...
     */
    get alignmentDirection(): FLOATING_MENU_DIRECTION_GROUP;
    /**
