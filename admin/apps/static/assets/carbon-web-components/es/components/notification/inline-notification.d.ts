...
declare const BXInlineNotification_base: {
    new (...args: any[]): {
        focus(): void;
        accessKey: string;
 ...
 */
declare class BXInlineNotification extends BXInlineNotification_base {
    /**
     ...
     */
    protected _renderButton(): import("lit-element").TemplateResult;
    /**
