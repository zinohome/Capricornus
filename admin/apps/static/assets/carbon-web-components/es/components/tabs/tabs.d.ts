 ...
 */
declare class BXTabs extends BXTabs_base {
    /**
    ...
    protected _selectionDidChange(itemToSelect: BXTab): void;
    /**
     * The color scheme.
     */
     ...
     */
    static getAction(key: string, { narrowMode }: {
        narrowMode?: boolean;
