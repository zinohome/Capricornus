...
var propTypes = {
  ...
  formatSelectedItemsCount: _propTypes.default.string,
  selectedRowsCount: _propTypes.default.number,
  onClickCancel: _propTypes.default.func,
};
exports.propTypes = propTypes;
const Component = (0, _createReactCustomElementType.default)(''.concat(prefix, '-table-batch-actions'), descriptor);
