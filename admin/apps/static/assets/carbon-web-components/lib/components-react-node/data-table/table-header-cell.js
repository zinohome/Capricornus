...
var propTypes = {
  sortActive: _propTypes.default.bool,
  sortCycle: _propTypes.default.string,
  sortDirection: _propTypes.default.string,
  onBeforeSort: _propTypes.default.func,
};
exports.propTypes = propTypes;
const Component = (0, _createReactCustomElementType.default)(''.concat(prefix, '-table-header-cell'), descriptor);
