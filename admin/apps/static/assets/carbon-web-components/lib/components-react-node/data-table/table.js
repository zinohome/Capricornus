...
Object.defineProperty(exports, 'TABLE_COLOR_SCHEME', {
  enumerable: true,
  get: function () {
    return _defs.TABLE_COLOR_SCHEME;
  },
});
...
const Component = (0, _createReactCustomElementType.default)(''.concat(prefix, '-table'), descriptor);
