...
var propTypes = {
  ...
  buttonLabelActive: _propTypes.default.string,
  buttonLabelInactive: _propTypes.default.string,
...
const Component = (0, _createReactCustomElementType.default)(''.concat(prefix, '-header-menu-button'), descriptor);
