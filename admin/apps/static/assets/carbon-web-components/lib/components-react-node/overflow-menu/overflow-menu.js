...
Object.defineProperty(exports, 'OVERFLOW_MENU_COLOR_SCHEME', {
  enumerable: true,
  get: function () {
    return _defs.OVERFLOW_MENU_COLOR_SCHEME;
  },
});
...
const Component = (0, _createReactCustomElementType.default)(''.concat(prefix, '-overflow-menu'), descriptor);
