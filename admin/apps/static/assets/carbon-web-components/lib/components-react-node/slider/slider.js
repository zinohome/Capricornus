...
var propTypes = {
  ...
  formatMaxText: _propTypes.default.string,
  formatMinText: _propTypes.default.string,
  labelText: _propTypes.default.string,
  max: _propTypes.default.number,
  min: _propTypes.default.number,
  name: _propTypes.default.string,
  step: _propTypes.default.number,
  stepRatio: _propTypes.default.number,
  value: _propTypes.default.number,
  onChange: _propTypes.default.func,
  onChangeInput: _propTypes.default.func,
};
exports.propTypes = propTypes;
const Component = (0, _createReactCustomElementType.default)(''.concat(prefix, '-slider'), descriptor);
