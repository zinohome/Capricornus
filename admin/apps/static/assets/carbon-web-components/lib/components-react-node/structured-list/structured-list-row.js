...
var propTypes = {
  ...
  selectionValue: _propTypes.default.string,
  selectionIconTitle: _propTypes.default.string,
};
exports.propTypes = propTypes;
const Component = (0, _createReactCustomElementType.default)(''.concat(prefix, '-structured-list-row'), descriptor);
