...
var propTypes = {
  formatLabelText: _propTypes.default.string,
  formatSupplementalText: _propTypes.default.string,
  total: _propTypes.default.number,
  value: _propTypes.default.number,
  onChange: _propTypes.default.func,
};
exports.propTypes = propTypes;
const Component = (0, _createReactCustomElementType.default)(''.concat(prefix, '-pages-select'), descriptor);
