...
var propTypes = {
  buttonAssistiveText: _propTypes.default.string,
  feedbackText: _propTypes.default.string,
  feedbackTimeout: _propTypes.default.number,
};
exports.propTypes = propTypes;
const Component = (0, _createReactCustomElementType.default)(''.concat(prefix, '-copy-button'), descriptor);
